...
function Sidemap({ lat, long }) {
  ...
  return (
    <div className="relative h-[600px] w-full lg:h-[calc(100vh-90px)] lg:w-[70%]">
      ...
      <div className="flex absolute p-3 gap-4 top-[25%] rounded-3xl md:left-[35%] bg-white text-[#54565B] w-[300px] h-[120px] md:h-[150px] md:w-[420px] ">
        <div><img src={purch} alt="prc" /></div>

        <div className="flex  flex-col gap-4">
          <div className="flex text-[18px] font-bold gap-3">
